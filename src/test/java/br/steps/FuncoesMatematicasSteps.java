package br.steps;
import br.Screens.CalculadoraScreen;
...
public class FuncoesMatematicasSteps {
    ...
    public void que_um_usuário_entrou_com_o_primeiro_numero_de_valor_para_realizar_a_soma(String number1) throws InterruptedException {
        Thread.sleep(3000);
    ...
    public void que_o_usuário_clicou_no_botão_de_soma() throws InterruptedException {
        Thread.sleep(3000);
